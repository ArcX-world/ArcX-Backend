...
import avatar.service.product.PresentService;
...
public class PresentOperationApi extends SystemEventHandler2<Session> {
    protected PresentOperationApi() {
        super(WebSocketCmd.C2S_PRESENT_MACHINE_OPERATION);
    }
        ...
        cachedPool.execute(() -> {
            try {
                ...
                if(ParamsUtil.isSuccess(status)){
                    ...
                    SendWebsocketMsgUtil.sendByAccessToken(WebSocketCmd.S2C_PRESENT_MACHINE_OPERATION, status,
