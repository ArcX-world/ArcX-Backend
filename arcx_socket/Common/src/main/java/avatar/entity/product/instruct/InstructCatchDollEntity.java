...
@Service
@Table(name="instruct_catch_doll" , comment = "娃娃机操作指令")
public class InstructCatchDollEntity extends BaseEntity {
    public InstructCatchDollEntity() {
        super(InstructCatchDollEntity.class);
    }
